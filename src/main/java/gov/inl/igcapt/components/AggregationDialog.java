...
public class AggregationDialog extends javax.swing.JDialog {
    ...
    List<SgComponentGroupData> theGroupList;
    ArrayList<SgComponentData> aggregateComponents;
    ...
    public AggregationDialog(IGCAPTgui igCAPTgui, boolean modal) {
        ...
        List<SgComponentData> allComponentsList = componentDao.getComponents();
        
        aggregateComponents = new ArrayList<>();
        for (SgComponentData component : allComponentsList) {
    ...
    private void aggregationNodeTypesComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aggregationNodeTypesComboBoxActionPerformed
        ...
        SgComponentData selectedComponent = aggregateComponents.get(selectedIndex);
        List<SgCollapseInto> collapseIntos = selectedComponent.getSgCollapseIntos();
        
        int numberOfUuids = collapseIntos.size();
        data = new Object [numberOfUuids][2];
        List<String> collapseIntoUuids = selectedComponent.getSgCollapseIntoUuids();
        ...
        for (String uuid : collapseIntoUuids) {
            SgComponentData theIncludedComponent = componentDao.getComponentByUUID(uuid);
    ...
    public SgComponentData getSelectedComponent() {
