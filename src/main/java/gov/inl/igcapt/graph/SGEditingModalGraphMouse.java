...
public class SGEditingModalGraphMouse<V, E> extends AbstractModalGraphMouse
    ...
    protected SGEditingGraphMousePlugin<V, E> editingPlugin;
    protected LabelEditingGraphMousePlugin<V, E> labelEditingPlugin;
    protected SGEditingPopupGraphMousePlugin1<V, E> popupEditingPlugin;
    ...
    protected void loadPlugins() {
        ...
        translatingPlugin = new SGTranslatingGraphMousePlugin(InputEvent.BUTTON1_MASK);
     ...
     */
    public SGEditingPopupGraphMousePlugin1<V, E> getPopupEditingPlugin() {
