    ...
    extends BaseBlock
{
    ...
    @XmlElement(name = "ConstrainingAttribute", namespace = "http://pnnl.gov/gdtaf-core")
    protected List<ConstrainingAttribute> constrainingAttribute;
    @XmlElement(name = "PossibleRole", namespace = "http://pnnl.gov/gdtaf-core", required = true)
    @XmlSchemaType(name = "string")
    protected List<EquipmentRole> possibleRole;
    @XmlElement(name = "PossibleZone", namespace = "http://pnnl.gov/gdtaf-core", required = true)
    @XmlSchemaType(name = "string")
    protected List<CommunicationZone> possibleZone;
    @XmlElement(name = "Icon", namespace = "http://pnnl.gov/gdtaf-core")
    protected byte[] icon;
    @XmlElement(name = "possible_children", namespace = "http://pnnl.gov/gdtaf-core")
    protected List<String> possibleChildren;
    @XmlElement(name = "possible_parents", namespace = "http://pnnl.gov/gdtaf-core")
    protected List<String> possibleParents;
    @XmlElement(name = "possible_peers", namespace = "http://pnnl.gov/gdtaf-core")
    protected List<String> possiblePeers;
    @XmlElement(name = "derived_from", namespace = "http://pnnl.gov/gdtaf-core")
    protected List<String> derivedFrom;
    @XmlElement(name = "available_data", namespace = "http://pnnl.gov/gdtaf-core")
