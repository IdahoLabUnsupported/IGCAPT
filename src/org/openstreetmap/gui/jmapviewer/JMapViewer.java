...
import igcapt.inl.components.NodeSelectionDialog;
...
//public class JMapViewer extends JPanel implements TileLoaderListener, DropTargetListener, MouseListener {
    ...
    public void mouseMoved(MouseEvent e) {
        ...
        if (_igCAPTgui.toolTipsEnabled) {
            ...
            for (SgNodeInterface node : nodes) {
                sgComponent = _igCAPTgui.getComponentGroupList().getComponentByUuid(node.getRefNode().getType());
    ...
    public void mousePressed(MouseEvent e) {
        if (e.getButton() == MouseEvent.BUTTON1) {
            ...
            // need to find the MapLine or MapImage corresponding to the SgEdge or SgNode so it can be removed
            if (mousePointIsOnLine) {
            ...
            if (mousePointIsOnNode) {
                ...
                JMenuItem collapseItem = popup.add(new AbstractAction("Collapse") {
                    public void actionPerformed(ActionEvent e) {
                        if (nodeToUse instanceof SgNode) {
                            ...
                            SgComponentGroupList sgComponentGroupList = _igCAPTgui.getComponentGroupList();
                ...
                JMenuItem settingsItem = popup.add(new AbstractAction("Component Settings") {
                    @Override
                    public void actionPerformed(ActionEvent e) {
    ...
    public void drop(DropTargetDropEvent e) {
        try {
            ...
            if (e.isDataFlavorSupported(stringFlavor)) {
                ...
                SgComponent sgComponent = _igCAPTgui.getComponentGroupList().getComponentByUuid(uuidStr);
                ...
                if (sgComponent != null) {
                    ...
                    if (sgComponent.getTypeUuid().equals(UUID.fromString("a169911e-9079-449f-b9b7-9f79efcec135"))) {
                        ...
                        SgNode n1 = new SgNode(_igCAPTgui.nodeIndex, uuidStr, sgComponent.getName() + "_" + String.valueOf(_igCAPTgui.nodeIndex), true, sgComponent.getIsPassthrough(),sgComponent.isAggregate(), 0, 0);
